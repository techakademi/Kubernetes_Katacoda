...
Created directory '/home/kubeadmin/.ssh'.
Enter passphrase (empty for no passphrase):
Enter same passphrase again:
Your identification has been saved in /home/kubeadmin/.ssh/deneme_rsa
Your public key has been saved in /home/kubeadmin/.ssh/deneme_rsa.pub
The key fingerprint is:
SHA256:2Wv5VGXY6PG3xkQvpT4W3tTksmSO9NkYv4UXD8bOjfc usta@example.com
...
`cat /home/kubeadmin/.ssh/deneme_rsa.pub`{{execute}}
...
`kubectl create secret generic ssh-key-secret --from-file=ssh-privatekey=/home/kubeadmin/.ssh/deneme_rsa --from-file=ssh-publickey=/home/kubeadmin/.ssh/deneme_rsa.pub`{{execute}}
